...
CREATE TABLE  StandardsandDescriptions (ID int NOT NULL AUTO_INCREMENT, Product_id int, FOREIGN KEY (Product_id) REFERENCES Product(ID), Standards_id int, FOREIGN KEY (Standards_id) REFERENCES Standards(ID), PRIMARY KEY (ID));
